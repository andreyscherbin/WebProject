...
public class IdTopicSpecification implements Specification<Topic> {
	private static final String SQL_SELECT_TOPICS_BY_ID = "SELECT topics.topic_id, topics.header, topics.content, topics.is_pinned, topics.is_closed, topics.creation_date, sections.section_id, sections.header, sections.description, users.user_id, users.username, users.password, users.email, users.register_date, users.last_login_date, "
	...
	public IdTopicSpecification(SearchCriterion searchCriteria) {
	...
	public String toSqlQuery() {
		...
		query.append(SQL_SELECT_TOPICS_BY_ID);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		IdTopicSpecification other = (IdTopicSpecification) obj;
		if (criterions == null) {
