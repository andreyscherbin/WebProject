...
public class TopicPostSpecification implements Specification<Post> {
	...
	public TopicPostSpecification(SearchCriterion searchCriteria) {
	...
	public String toSqlQuery() {
		...
		query.append(SQL_SELECT_POSTS_BY_TOPIC);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TopicPostSpecification other = (TopicPostSpecification) obj;
		if (criterions == null) {
