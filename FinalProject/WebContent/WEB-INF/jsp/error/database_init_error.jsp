...
<fmt:message key="database_init_error.title" var="title_message" />
<fmt:message key="database_init_error.error_details"
	var="error_details_message" />
<fmt:message key="database_init_error.home" var="home_message" />
